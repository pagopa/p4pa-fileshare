locals {
  ...
  common_tags = {
    ...
    Source      = "https://github.com/pagopa/p4pa-fileshare" # Repository URL
  ...
  github = {
    org        = "pagopa"
    repository = "p4pa-fileshare" # Repository Name
  }
  ...
  repo_env = var.env_short == "p" ? {
    SONARCLOUD_PROJECT_NAME = "p4pa-fileshare"
    SONARCLOUD_PROJECT_KEY  = "pagopa_p4pa-fileshare"
