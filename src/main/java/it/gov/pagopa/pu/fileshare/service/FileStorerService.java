...
public class FileStorerService {
  ...
  public SaveFileResultDTO saveToSharedFolder(Long organizationId, MultipartFile file, String relativePath, String fileName) {
    if (file == null) {
      ...
      throw new InvalidFileException("MISSING_FILE", "[MISSING_FILE] File is mandatory");
    }
    ...
    try {
      ...
      throw new FileUploadException(
        "FILE_UPLOADING_ERROR", "[FILE_UPLOADING_ERROR] Error uploading file to shared folder %s".formatted(relativePath), e);
    }
  ...
  public static Path concatenatePaths(String firstPath, String secondPath) {
    ...
    if (!concatenatedPath.startsWith(firstPath)) {
      ...
      throw new InvalidFileException("INVALID_FILE_PATH", "[INVALID_FILE_PATH] Invalid file path");
    }
